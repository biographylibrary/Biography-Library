...
export const HELP_KB_SECTIONS: KbSection[] = [
  ...
  },
  {
    ...
    content: {
      en: `Book Structure panel (left sidebar): optional front matter (Dedication, Epigraph, Preface) and back matter (Epilogue, Acknowledgements, Credits) for PDF export. Notes & To-Do: private notepad, not exported. Photos: upload JPG/PNG/WEBP up to 5 MB, max 10 photos, captions, reorder by drag; included in online reader and PDF gallery after last chapter.`,
      it: `Pannello Struttura libro (barra laterale): frontespizio opzionale (Dedica, Epigrafe, Prefazione) e fine libro (Epilogo, Ringraziamenti, Crediti) per PDF. Note e To-Do: blocco note privato, non esportato. Foto: JPG/PNG/WEBP fino 5 MB, max 10, didascalie, riordino trascinando; incluse nel lettore online e galleria PDF dopo l'ultimo capitolo.`,
      fr: `Panneau Structure du livre : avant-propos optionnel (Dédicace, Épigraphe, Préface) et fin (Épilogue, Remerciements, Crédits) pour le PDF. Notes & To-Do : bloc-notes privé, non exporté. Photos : JPG/PNG/WEBP jusqu'à 5 Mo, max 10, légendes, réordonner par glisser-déposer ; incluses dans le lecteur et la galerie PDF après le dernier chapitre.`,
      de: `Buchstruktur-Panel: optionales Vorspann (Widmung, Epigraph, Vorwort) und Nachspann (Epilog, Danksagungen, Credits) für PDF. Notizen & To-Do: privates Notizbuch, nicht exportiert. Fotos: JPG/PNG/WEBP bis 5 MB, max. 10, Bildunterschriften, per Drag & Drop sortieren; im Online-Leser und PDF-Galerie nach dem letzten Kapitel.`,
    },
  },
  {
