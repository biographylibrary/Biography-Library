...
export type AgentStreamEvent =
  ...
  | { event: 'tool_result'; data: { tool: string; sectionKey?: string; contentLength?: number; draftText?: string; replaceText?: string; replaceAll?: boolean; preview?: boolean; wordCount?: number; assistantMessageId?: string } }
